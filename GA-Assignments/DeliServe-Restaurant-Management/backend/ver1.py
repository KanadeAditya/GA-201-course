...
def add_dish():
    dish = request.json
    print(dish)
    mongo.db.menu.insert_many(dish)
...
#     # Extracting data from the socket event
#     print(data)

#     # Process the updated order and broadcast the information to all connected clients
#     # Emit the updated order information using socketio.emit()
#     pass
